...
<script>
    ...
    <div class="jumbotron jumbotron-zh">
        ...
        <!--<a href="#" id="newPhoto" class="btn btn-flat btn-info">上传照片</a>-->
    </div>
...
<div class="container bg-album">
    <div id="photoList" class="row padding-5 margin-t-20">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-md-4 col-lg-3 padding5">
                <div class="box box-info">
                    ...
                    <div class="photothumb">
                        <img src="/Public/plugins/lazyload/images/grey.gif" original="<?php echo ($item["url"]); ?>" alt="<?php echo ($item["title"]); ?>" class="lazy">
                    </div>
