...
<div class="container bg-photo">
    <div id="photoList" class="row padding-5 margin-t-20">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-md-4 col-lg-3 padding5 block">
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title text-info"><?php echo ($item["title"]); ?></h3>
                        <div class="box-tools pull-right">
                            <a href="javascript:;" class="label bg-aqua">点个赞</a>
                        </div>
                    </div>
                    <div class="photowall">
                        <img src="/Public/plugins/lazyload/images/grey.gif" original="<?php echo ($item["url"]); ?>" alt="<?php echo ($item["title"]); ?>" class="lazy img-fixed-w">
                    </div>
                    <div class="box-footer">
                        <span class="text-warning">哇，哇，哇</span>
                    </div>
                </div>
...
<script src="/Public/plugins/blocksit/blocksit.js"></script>
<script>
    $(function() {
        $("img.lazy").lazyload({
            effect: "fadeIn"
