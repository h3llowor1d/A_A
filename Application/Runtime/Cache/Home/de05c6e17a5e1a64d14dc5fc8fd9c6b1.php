...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <div class="panel" style="padding: 20px;">
        <div class="form-group form-group-sm" style="height: 40px;line-height: 40px;">
            ...
            <div class="col-sm-10">
                <input type="text" id="title" class="form-control" value="<?php echo ($data["title"]); ?>">
            </div>
        </div>
        <div class="form-group form-group-sm" style="height: 40px;line-height: 40px;">
            <label class="col-sm-1 control-label">标签</label>
            <div id="select_tags" class="col-sm-10">
                <?php if(is_array($tagList)): $i = 0; $__LIST__ = $tagList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tagItem): $mod = ($i % 2 );++$i;?><a href="javascript:;" data-tagid="<?php echo ($tagItem["id"]); ?>" class="label margin-r-10 label-danger"><?php echo ($tagItem["tagname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="col-sm-11">
                <div id="uploader-demo">
                    ...
                    <div id="imgDiv" class="file-item thumbnail1">
                        <img style="height: 200px;width:auto;" src="<?php echo ($data["img"]); ?>">
                    </div>
        ...
        <div style="margin-bottom: 30px;">
            ...
            <input type="hidden" id="imgurl" value="<?php echo ($data["img"]); ?>">
        ...
        <div id="content" style="display: none"><?php echo (htmlspecialchars_decode($data["content"])); ?></div>
    </div>
</div>
<script>
    $(function(){
    ...
    $(function(){
        ...
        $("#save").on('click',function(){
            ...
            var tags = $("input[name=tags]").val(),
                img = $("#imgurl").val();
            $.post("/a/blog/update/<?php echo ($data["id"]); ?>",{
                id:"<?php echo ($data["id"]); ?>",
                tags : tags,
                img:img,
                desc :desc,
