...
<div class="theme-showcass" style="margin: 20px;" role="main">
    <div class="box box-info">
        ...
        <div class="box-body">
            <table class="table table-bordered" style="vertical-align: middle">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                        <td><input type="checkbox" type="checkbox" name="id" value="<?php echo ($item["id"]); ?>"></td>
                        ...
                        <td><a href="/a/blog/update/<?php echo ($item["id"]); ?>">编辑</a> | <a href="javascript:;">删除</a></td>
        ...
        <div class="box-footer">
            ...
            <div class="jogger pager"><?php echo ($pageHtml); ?></div>
        </div>
    </div>
</div>
