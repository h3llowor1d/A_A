    ...
    class Mail2 {
        ...
        protected function socket() {
            ...
            if(!socket_connect($this->_socket, $this->_sendServer, $this->_port)) {
                $this->_errorMessage = socket_strerror(socket_last_error());
                //echo $this->_errorMessage."22";exit;
                return false;
            }
            /*if (false !== ($bytes = socket_recv($this->_socket,$str,1024,MSG_WAITALL))) {
                //echo "Read $bytes bytes from socket_recv(). Closing socket...";
                echo $str;
            } else {
                echo "socket_recv() failed; reason: " . socket_strerror(socket_last_error($this->_socket)) . "<br>";
            }*/

            //exit;
            //$str = socket_read($this->_socket, 1024,PHP_BINARY_READ);
            socket_recv($this->_socket,$str,1024,MSG_WAITALL);
            _log("socket:socket_read ".$str);
        ...
        /*public function sendEmailAction() {
            ...
            $content = file_get_contents("http://zhanhao.tv/Blog/list");
            ...
            $mail->setReceiver("2509263366@qq.com");
