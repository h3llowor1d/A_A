...
class Qiniu{
    ...
    private $config = array(
        'secrectKey'     => 'amwf5MqMyWXc8OwNSPVUYRYuTfiYAUPnDk_MCaBU', //七牛服务器
        'accessKey'      => '6SvfeSbuFD6PKk5MTiHKIsE0hbJSa1n9VLNw0448', //七牛用户
        'domain'         => '7xo75r.com1.z0.glb.clouddn.com', //七牛密码
        'bucket'         => 'focus', //空间名称
        'timeout'        => 300, //超时时间
    );
